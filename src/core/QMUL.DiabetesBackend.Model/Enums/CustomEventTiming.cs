...
/// <summary>
/// Event times in the day. E.g., morning, breakfast, evening, etc. Copied from the HL7 library
/// </summary>
...
public enum CustomEventTiming
{
    ...
    /// </summary>
    [EnumLiteral("SNACK", "http://localhost"), Description("SNACK")]
    SNACK,
    ...
    /// (system: http://localhost)
    /// </summary>
    [EnumLiteral("EXACT", "http://localhost"), Description("EXACT")]
    EXACT,
    ...
    /// (system: http://localhost)
    /// </summary>
    [EnumLiteral("ALL_DAY", "http://localhost"), Description("ALL_DAY")]
    ALL_DAY,
}